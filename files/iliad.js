...
Jupiter's stay with the Ćthiopians, at whose return Thetis prefers her
...
lastly to Olympus.
  ...
  The feasts of Ćthiopia's blameless race,(66)
...
removes to Troy.
  ...
  Who from Ćsetes' tomb observed the foes,(105)
...
book). The scene is wholly in the field before Troy.
  ...
  Whose squadrons, led from black Ćsepus' flood,(130)
  ...
  (Who from cold Ćnus led the Thracian crew,)(142)
...
lies in the field towards the seashore.
  ...
  Yet Ćgae, Helice, thy power obey,(195)
...
Alcathous: Deiphobus and Ćneas march against him, and at length Idomeneus
...
described, when the deities are engaged. Apollo encourages Ćneas to meet
Achilles. After a long conversation, these two heroes encounter; but Ćneas
...
corpus = corpus.split('\n');
corpus = corpus.filter(function(line) {return line.match(/^  [A-Za-z]/g)});
